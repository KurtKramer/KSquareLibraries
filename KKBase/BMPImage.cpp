...
bool  BmpImage::ReversedGrayscaleImage ()
{
  ...
  //int32  firstUnbalancedChannel = (int32)0;
...
public:
  ...
  int32  NumOfColors ()  const  {return (int32)colorsUsed.size ();}
                 ...
                 )
  {
    ...
    if  (idx == colorsUsed.end ())
    {
      int32  numEntries = (int32)colorsUsed.size ();
